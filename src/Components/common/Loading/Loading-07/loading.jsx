...
function loading() {
  return (
    <div>
      <div className="loader-loader-07">
        <div className="wrapper-loader-07">
          <div className="catContainer-loader-07">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 733 673"
              className="catbody-loader-07"
            >
              <path
                fill="#212121"
            ...
            <div className="text">
              <span className="bigzzz-loader-07">Z</span>
              <span className="zzz-loader-07">Z</span>
            </div>
          </div>
          <div className="wallContainer-loader-07">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 500 126"
